...
namespace hand
{
	...
	{
		const int alpha = (time_ > 0.75s) ? Periodic::Square0_1(0.08s) * 255 : 255;
		const Color color = Palette::White.lerp(Theme::Lighter, Periodic::Square0_1(0.13s)).withAlpha(alpha);
